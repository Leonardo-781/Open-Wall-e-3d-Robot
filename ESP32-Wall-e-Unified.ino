// ============================================================
// Wall-E 3D Robot - ESP32 UNIFIED VERSION
// Integração completa: Servidor Web + Controle de Motores + Servos
// Elimina necessidade do Arduino Mega2560
// ============================================================
...
const int SPEAKER_PIN = 23;       // Auto-falante (funciona como buzzer com PWM)
...
#define SCREEN_ADDRESS 0x3C          // Endereço I2C padrão
...
void setup() {
  ...
  Serial.println("\n=== Wall-E 3D Robot - ESP32 Unified Starting ===");
  ...
  // Atualizar display OLED com informações iniciais
  delay(1000);
  updateOLEDDisplay();
}
